                        ...
                        <div className="payment-check">
                            ...
                            <div className={carddetails ? 'detailsenable' : 'detailsdisable'}>
                                <div>
                                    ...
                                    <br />
                                    <Input variant="flushed" id="name-card" placeholder="Nguyen Van A" />
                                </div>
                                <div>
                                    ...
                                    <br />
                                    <Input variant="flushed" id="number-card" placeholder="3333-1111-8888-2222" />
                                </div>
                                <div>
                                    ...
                                    <br />
                                    <Input variant="flushed" id="expir-mt-card" placeholder="January" />
                                </div>
